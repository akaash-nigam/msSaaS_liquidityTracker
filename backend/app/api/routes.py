...
# ---------------------------------------------------------------------------
# Liquidity Destination Endpoints (Phase 5)
# ---------------------------------------------------------------------------
...
def get_historical_comparison(db: Session = Depends(get_db)):
    ...
    try:
        ...
        if us_rows and jp_rows:
            # Deduplicate by year (take latest in each year)
            us_by_year = {}
            for r in us_rows:
