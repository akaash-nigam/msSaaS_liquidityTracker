...
export default function GliChart() {
  ...
  const { data } = useSWR<GliHistoricalPoint[]>(
    `${API_BASE}/gli/historical?timeframe=${timeframe}`,
    fetcher
  );
      ...
      <div className="h-72">
        {data ? (
          <ResponsiveContainer width="100%" height="100%">
            <AreaChart data={data}>
              <defs>
                <linearGradient id="gliGradient" x1="0" y1="0" x2="0" y2="1">
              ...
              <Tooltip
                ...
                formatter={(value) => [`$${Number(value).toFixed(2)}T`, "GLI"]}
              />
              <Area
                type="monotone"
                dataKey="value"
